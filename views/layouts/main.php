...
<div class="wrap">
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] = ['label' => 'Stores', 'url' => ['/store/index']];
        $menuItems[] = ['label' => 'Inventory', 'url' => ['/inventory/index']];
        $menuItems[] = ['label' => 'Input Batches', 'url' => ['/inputbatch/index']];
        $menuItems[] = '<li>'
    ...
    $menuItems[] = ['label' => 'Contact', 'url' => ['/site/contact']]; //,'visible'=>false],
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; Pontoon Plus Limited <?= date('Y') ?></p>
